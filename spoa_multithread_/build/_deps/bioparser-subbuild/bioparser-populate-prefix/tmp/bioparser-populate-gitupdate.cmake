...
execute_process(
  COMMAND "/usr/bin/git" show-ref "3.0.13"
  WORKING_DIRECTORY "/home/kevin/spoa/build/_deps/bioparser-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/kevin/spoa/build/_deps/bioparser-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/kevin/spoa/build/_deps/bioparser-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
