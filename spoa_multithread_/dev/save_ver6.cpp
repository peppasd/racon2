...
// std::pair<std::uint32_t, std::uint32_t> SisdAlignmentEngine::test(auto it, auto max_val){
...
void SisdAlignmentEngine::parallel_aligment(spoa::Graph::Node* it, int tid){    
    const auto& char_profile =
        &(pimpl_->sequence_profile[it->code * matrix_width]);
...
void SisdAlignmentEngine::parallel_aligment(spoa::Graph::Node* it){    
    const int32_t* char_profile =
        &(pimpl_->sequence_profile[it->code * matrix_width]);
...
void SisdAlignmentEngine::test(spoa::Graph::Node* it){
    const auto& char_profile =
        &(pimpl_->sequence_profile[it->code * matrix_width]);
