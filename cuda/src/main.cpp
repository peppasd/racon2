...
#include "../include/poa_base.hpp"
#include "../include/batch.hpp"
#include "../include/cudautility.hpp"
#include "../include/utils.hpp"
#include "../include/signed_integer_utilits.hpp"
...
int main(int argc, char** argv)
{
    ...
    if (long_read)
    {
        const std::string input_file = std::string("../data/sample-bonito.txt");
        parse_cudapoa_file(windows, input_file, -1);
    }
    else
    {
        const std::string input_file = std::string("../data/window.txt");
